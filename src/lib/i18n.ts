...
const translations: Record<CVLanguage, Record<TranslationKey, string>> = {
  fr: {
    ...
    pricingMobility: 'HireNova Mobilité (OCR + IA)',
    pricingGlobalJobs: 'HireNova Global (40+ pays)',
  ...
  en: {
    ...
    pricingMobility: 'HireNova Mobility (OCR + AI)',
    pricingGlobalJobs: 'HireNova Global (40+ countries)',
  ...
  ar: {
    ...
    pricingMobility: 'HireNova Mobility (OCR + AI)',
    pricingGlobalJobs: 'HireNova Global (40+ دولة)',
  ...
  es: {
    ...
    pricingMobility: 'HireNova Mobility (OCR + IA)',
    pricingGlobalJobs: 'HireNova Global (40+ países)',
